    ...
    "paths": {
        ...
        "/connectors/{id}/warehouse": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Warehouse link (null unlinks)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/groups/{id}/pending-members": {
            ...
            "post": {
                ...
                "description": "Stage group memberships by email for people who do not have an\naccount yet. Existing org members are added directly; emails that\nalready belong to a member of the group are skipped.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/groups/{id}/pending-members/{email}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/warehouses/{id}": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Unlink linked connectors and delete",
                        "name": "force",
                        "in": "query"
                    }
                ],
        ...
        "/warehouses/{id}/effective-access": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "User ID (org admins only; defaults to the caller)",
                        "name": "user_id",
                        "in": "query"
                    }
                ],
        ...
        "/warehouses/{id}/grants": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Grant subject and table",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Grant already existed",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/warehouses/{id}/new-tables": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "RFC3339 cutoff timestamp (defaults to the last grant review)",
                        "name": "since",
                        "in": "query"
                    }
                ],
        ...
        "/warehouses/{id}/preference": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Preferred connector (null clears)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/warehouses/{id}/provisioner": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Provisioner connector (null clears)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
