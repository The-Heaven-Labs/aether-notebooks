...
var BuiltinTools = []BuiltinToolDef{
	...
	{Name: "create_chart", Description: "Create a chart from cell output. NOTE: group_by only works with chart_type=timeline", HandlerName: "create_chart"},
	{Name: "update_chart", Description: "Update an existing chart. NOTE: group_by only works with chart_type=timeline; series_colors keys must match y_columns or group values", HandlerName: "update_chart"},
