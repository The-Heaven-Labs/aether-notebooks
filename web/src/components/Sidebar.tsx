...
import { Home, LayoutDashboard, Database, Users, UsersRound, ClipboardList, ChevronLeft, ChevronRight, User } from 'lucide-react'

const NAV_ITEMS = [
  { to: '/',           title: 'Files',       icon: <Home size={16} /> },
  { to: '/home',       title: 'Home',        icon: <User size={16} /> },
