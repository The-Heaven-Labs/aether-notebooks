...
const rowStyles: Record<string, React.CSSProperties> = {
  ...
  badge: { fontSize: 10, fontWeight: 700, color: '#666', background: '#f5f5f5', padding: '2px 6px', borderRadius: 3, flexShrink: 0 },
...
const styles: Record<string, React.CSSProperties> = {
  ...
  publicBadge: { marginTop: 8, display: 'inline-block', fontSize: 10, fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', color: '#666', background: '#f5f5f5', padding: '2px 7px', borderRadius: 3 },
  deleteBtn: {
    position: 'absolute',
    top: 10,
    right: 10,
