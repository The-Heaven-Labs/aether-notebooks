...
function BarChartComponent({ data, config }: ChartProps) {
  ...
  }, [chartData, xAxis, yAxes, isStacked, isHorizontal, hasGroupBy, groupSeries, xValues, config.title, config.seriesColors, config.showLegend, config.showLabels, config.showGrid, config.dataZoom, config.barWidth, config.barCategoryGap, colors])
